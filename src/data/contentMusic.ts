...
const contentMusic: ContentMusicProps[] = [
  ...
  // { title: "Aus LICHT", sections: [{ text: "" }], mainImg: ImgAusLicht },
  // { title: "TIERKREIS", sections: [{ text: "" }], mainImg: ImgTierkreis },
  // {
